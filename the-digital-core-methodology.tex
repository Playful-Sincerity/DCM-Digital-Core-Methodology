...
It is, intentionally, plain text. Markdown, shell scripts, JSON config, and the occasional Python utility. No proprietary database; no learned compression of memory; no opaque indexing layer. The whole digital core fits in a zip file---typically tens of megabytes for an actively-used system, including the chronicle. It can be cloned, forked, archived, restored, and audited by anyone with a text editor.
